 ...
 * desc:
 */
class ColorFilter(context: Context, filter: Filter?) :
        AFilter(context, "filter/default_vertex.sh", "filter/color_fragment.sh") {
    ...
    enum class Filter(val type: Int, private val data: FloatArray) {
        NONE(0, floatArrayOf(0.0f, 0.0f, 0.0f)), GRAY(1, floatArrayOf(0.299f, 0.587f, 0.114f)), COOL(2, floatArrayOf(0.0f, 0.0f, 0.1f)), WARM(2, floatArrayOf(0.1f, 0.1f, 0.0f)), BLUR(3, floatArrayOf(0.006f, 0.004f, 0.002f)), MAGN(4, floatArrayOf(0.0f, 0.0f, 0.4f));
