...
class BallWithLight(view: View) : Shape(view) {
    ...
    init {
        ...
        val buffer: ByteBuffer = ByteBuffer.allocateDirect(dataPos.size * 4)
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        mProgram = createProgram(mView!!.resources, "vshader/BallWithLight.sh", "fshader/BallWithLight.sh")
    }
